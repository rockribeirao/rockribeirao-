      ...
      <section id="about" className="py-20 border-t-4 border-primary" style={{
        ...
        <div className="container max-w-3xl">
          ...
          <div className="space-y-6 text-gray-300 text-lg">
            ...
            <p><strong className="text-primary">Em parceria com a North Star Concerts.</strong></p>
            <p><strong className="text-primary">Com presença de marcas como</strong> Kiss FM 105.3 – Ribeirão Preto, School of Rock Ribeirão Preto, Viva Mídia e Dritto Mídia Out of Home.</p>
          </div>
        </div>
      </section>
