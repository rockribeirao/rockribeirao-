...
const upcomingShows: Show[] = [
  ...
  { id: 51, name: "MACH 5", date: "31/07", month: "Julho", time: "21h", venue: "Hard Rock Cafe", link: "https://www.sympla.com.br/evento/mach5-os-classicos-do-pop-rock-no-hard-rock-cafe-ribeirao/3469728", image: "https://github.com/rockribeirao/rockribeirao-/blob/main/client/public/Mach%205202607.jpeg", partnership: true, partnerName: "Matiz Hotel" },
...
const realizedShows2026: Show[] = [
  ...
  { id: 6, name: "BETO BRUNO & STARS FROM SCHOOL OF ROCK", subtitle: "NORTH STAR", date: "07/02", month: "Fevereiro", time: "21h", venue: "Hard Rock Cafe", realized: true, partnership: true, partnerName: "North Star Concerts" },
  { id: 7, name: "MOJOBOX", subtitle: "NORTH STAR", date: "13/02", month: "Fevereiro", time: "21h", venue: "Hard Rock Cafe", realized: true, partnership: true, partnerName: "North Star Concerts" },
  { id: 8, name: "BANDA 365", subtitle: "NORTH STAR", date: "15/02", month: "Fevereiro", time: "21h", venue: "Hard Rock Cafe", realized: true, partnership: true, partnerName: "North Star Concerts" },
  { id: 9, name: "VIOLÕES EM FÚRIA", subtitle: "NORTH STAR", date: "22/02", month: "Fevereiro", time: "21h", venue: "Hard Rock Cafe", realized: true, partnership: true, partnerName: "North Star Concerts" },
  { id: 10, name: "NIRVANA COVER BRASIL", subtitle: "NORTH STAR", date: "28/02", month: "Fevereiro", time: "21h", venue: "Hard Rock Cafe", realized: true, partnership: true, partnerName: "North Star Concerts" },
  { id: 11, name: "CREEDENCE 4EVER", subtitle: "NORTH STAR", date: "07/03", month: "Março", time: "21h", venue: "Hard Rock Cafe", realized: true, partnership: true, partnerName: "North Star Concerts" },
  { id: 12, name: "FENÍCIA", subtitle: "ESPECIAL DIA DAS MULHERES", date: "08/03", month: "Março", time: "21h", venue: "Hard Rock Cafe", realized: true },
  { id: 13, name: "MR. DAM", subtitle: "ESPECIAL QUEEN", date: "14/03", month: "Março", time: "21h", venue: "Hard Rock Cafe", realized: true },
  { id: 14, name: "NIRVANA COVER BRASIL", subtitle: "NORTH STAR", date: "29/03", month: "Março", time: "21h", venue: "Hard Rock Cafe", realized: true, partnership: true, partnerName: "North Star Concerts" },
];
