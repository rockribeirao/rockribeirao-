...
export default function TodosNoRock() {
  ...
  const s: Record<string, React.CSSProperties> = {
    ...
    leiImg: { height: 32, maxWidth: 160, objectFit: "contain" as const, filter: "brightness(10)" },
    ...
    logoImg: { height: 40, maxWidth: 140, objectFit: "contain" as const, opacity: 0.85, filter: "brightness(10)" },
